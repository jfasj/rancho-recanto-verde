...
for col in [
    ...
    "preco_unitario", "custo_total", "veterinario", "retorno", "obs"
]:
...
# =========================================================
    ...
    titulo_pagina("🩺 Veterinário / Tratamentos", "Atendimentos, diagnósticos e baixa automática de estoque")
    ...
    if aba == "Registrar Tratamento":
        if animais.empty:
            ...
            with col2:
                medicamentos = ["Nenhum"]
                if not farmacia.empty:
                    medicamentos += farmacia["medicamento"].tolist()
                ...
                veterinario = st.text_input("Veterinário / Responsável")
            ...
            if st.button("Salvar Tratamento e Baixar Estoque"):
                ...
                """, (
                    ...
                    str(preco_unitario), str(custo_total), veterinario, br_data(retorno), obs
                ))
